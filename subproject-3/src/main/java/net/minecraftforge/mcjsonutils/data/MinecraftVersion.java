 ...
 */
package net.minecraftforge.mcjsonutils.data;

import net.minecraftforge.mcjsonutils.OS;
...
public class MinecraftVersion {
    ...
    public static class Rules {
        ...
        public static class OS {
            ...
            public net.minecraftforge.mcjsonutils.OS toOS() {
                return switch (name) {
                    case "windows" -> net.minecraftforge.mcjsonutils.OS.WINDOWS;
                    case "linux" -> net.minecraftforge.mcjsonutils.OS.LINUX;
                    case "osx" -> net.minecraftforge.mcjsonutils.OS.MACOS;
                    default -> net.minecraftforge.mcjsonutils.OS.UNKNOWN;
                };
            }
        }
    }
